...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [dic1 setValue:@"13:45:30" forKey:@"时间"];
    [dic1 setValue:@"156.00" forKey:@"成交价"];
    [dic1 setValue:@"200" forKey:@"数量"];
    NSMutableDictionary *dic2 = [NSMutableDictionary new];
    [dic2 setValue:@"13:46:26" forKey:@"时间"];
    [dic2 setValue:@"156.00" forKey:@"成交价"];
    [dic2 setValue:@"100" forKey:@"数量"];
    
     NSMutableDictionary *dic3 = [NSMutableDictionary new];
    [dic3 setValue:@"13:46:53" forKey:@"时间"];
    [dic3 setValue:@"158.00" forKey:@"成交价"];
    [dic3 setValue:@"200" forKey:@"数量"];
    NSMutableArray *Arr1 = [NSMutableArray arrayWithObjects:dic1,dic2,dic3,nil];
    
    NSMutableDictionary *dic = [NSMutableDictionary dictionaryWithObjectsAndKeys:@"买入",@"1_证券操作",@"竞价限价盘",@"2_交易类型",@"00700",@"3_证券代码",@"腾讯控股",@"4_证券名称",@"1500",@"5_委托数量",@"1500",@"6_成交数量",@"156.00",@"7_委托价格",@"158.00",@"8_成交均价",@"2015-06-01 14:30:20",@"9_委托时间",@"已成交",@"10_成交状态",@"GGTTTTT001.1025",@"11_委托编号",@"HKATTTT001.0152",@"12_客户编号",Arr1,@"13_成交明细", nil];
    if ([_delegate respondsToSelector:@selector(didSelectCellSendArry:andSendDic:)]) {
        [_delegate didSelectCellSendArry:nil andSendDic:dic];
    }
}

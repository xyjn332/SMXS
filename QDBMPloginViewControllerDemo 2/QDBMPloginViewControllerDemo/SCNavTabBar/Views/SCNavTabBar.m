...
{
    _items = [@[] mutableCopy];
    _arrowImage = [UIImage imageNamed:SCNavTabbarSourceName(@"zxg_right")];
...
- (void)popItemMenu:(BOOL)pop
{
    if (pop)
    {
        ...
        [UIView animateWithDuration:0.5f animations:^{
            ...
            _arrowButton.transform = CGAffineTransformMakeRotation(M_PI*3/2);
    ...
    else
    {
        [UIView animateWithDuration:0.5f animations:^{
            ...
            _arrowButton.transform = CGAffineTransformMakeRotation(M_PI/2);//CGAffineTransformIdentity;
        } completion:^(BOOL finished) {
